...
from train_model.qa_baseline import qa_baseline
...
#     print(final_image_embedding_dim)
# 
#     inter_model = None
# 
...
def prepare_model(num_vocab_txt, num_choices, **model_config):
    model = qa_baseline(num_vocab=num_vocab_txt, out_dim=num_choices, **model_config)
    return model
